...
//	int sendDatagram(char *p,  int len, int seqno,
...
//	bool listenForAck();
//
//	int sendPacket(string hash, char *line, int t,
//				struct sockaddr_in toAddr);
//public:
//	StopAndWaitProtocol();
//
...
//
//	virtual void sendFile(string fileName, string hash, struct sockaddr_in toAddr);
//
